...
const cartUrls: Record<string, string> = {
  ...
  "Zaptec Go 22kW": "https://evionor.hu/collections/all/products/zaptec-go-2-home-ev-charger-22kw2kw-ev-charger-installation-bundle?_pos=8&_fid=5b9cabd46&_ss=c",
